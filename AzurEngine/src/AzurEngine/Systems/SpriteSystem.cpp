...
void SpriteSystem::Init()
{
	...
	player = CreateSprite(AzurEngine::Application::renderer, player_filename,  player_x, player_y, player_w, player_h);
	...
	bullet_a = CreateSprite(AzurEngine::Application::renderer, bullet_a_filename, bullet_a_x, bullet_a_y, bullet_a_w, bullet_a_h);
	...
	blank_texture = CreateSprite(AzurEngine::Application::renderer, blank_texture_filename, blank_texture_x, blank_texture_y, blank_texture_w, blank_texture_h);
}
...
SpriteData* SpriteSystem::CreateSprite(SDL_Renderer* renderer, const char* imageFileName, int x, int y, int w, int h)
{
	...
	sprite->rect.x = AzurEngine::Application::GetWindowTrueX((float)x);
	sprite->rect.y = AzurEngine::Application::GetWindowTrueY((float)y);
	sprite->rect.w = AzurEngine::Application::GetWindowTrueX((float)w);
	sprite->rect.h = AzurEngine::Application::GetWindowTrueY((float)h);
